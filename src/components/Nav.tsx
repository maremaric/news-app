        ...
        <div className='bg-primary-blue py-3'>
            <div className='max-w-[800px] w-[100%] mx-auto'>
                <div className='flex items-center justify-center gap-4'>
                    <button 
                        className={`text-[#fff] px-4 py-2 rounded-md ${category === 'general' ? 'active bg-blue-600' : 'bg-blue-400'} hover:bg-blue-500`}
                        onClick={() => handleCategoryChange('general')}>
                        Top News
                    </button>
                    <button 
                        className={`text-[#fff] px-4 py-2 rounded-md ${category === 'business' ? 'active bg-blue-600' : 'bg-blue-400'} hover:bg-blue-500`}
                        onClick={() => handleCategoryChange('business')}>
                        Business
                    </button>
                    <button 
                        className={`text-[#fff] px-4 py-2 rounded-md ${category === 'technology' ? 'active bg-blue-600' : 'bg-blue-400'} hover:bg-blue-500`}
                        onClick={() => handleCategoryChange('technology')}>
                        Technology
                    </button>
                    <button 
                        className={`text-[#fff] px-4 py-2 rounded-md ${category === 'science' ? 'active bg-blue-600' : 'bg-blue-400'} hover:bg-blue-500`}
                        onClick={() => handleCategoryChange('science')}>
                        Science
                    </button>
                    <button 
                        className={`text-[#fff] px-4 py-2 rounded-md ${category === 'sport' ? 'active bg-blue-600' : 'bg-blue-400'} hover:bg-blue-500`}
                        onClick={() => handleCategoryChange('sport')}>
                        Sport
                    </button>
                    <button 
                        className={`text-[#fff] px-4 py-2 rounded-md ${category === 'Health' ? 'active bg-blue-600' : 'bg-blue-400'} hover:bg-blue-500`}
